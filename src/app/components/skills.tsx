...
export function Skills() {
  const skillCategories = [
    ...
    {
      name: "DevOps & Tools",
      description: "Tools and practices for efficient development and deployment",
      ...
      <div className="container mx-auto px-4">
        ...
        <Card className="mt-12">
          <CardHeader>
            ...
            <CardDescription>Personal attributes that enable me to interact effectively and harmoniously with others</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-2">
